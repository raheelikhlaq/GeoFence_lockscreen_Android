...
var PrayerWallPage = /** @class */ (function () {
    function PrayerWallPage(modalController, apiService, storage, loader, datePipe, appService, toast, location, common, event_provider, analytics, platform, device, translate, dom) {
        var _this = this;
    ...
    PrayerWallPage.prototype.ngOnInit = function () {
        ...
        var res = JSON.parse(localStorage.getItem('church_data'));
        ...
        // saving app_pages
        var body = JSON.stringify({ id: this.churchId });
    ...
    PrayerWallPage.prototype.getGradient = function (color_one, bg_color) {
        if (bg_color === '') {
    ...
    PrayerWallPage.prototype.getUser = function () {
        var _this = this;
        ...
        this.storage.get('user').then(function (res) {
            if (res != null && res != 'guest') {
                ...
                _this.name = (res.user.first_last_name).split(' ')[0];
                _this.last_name = (res.user.first_last_name).split(' ')[1];
            }
        });
    };
    PrayerWallPage.prototype.getPrayers = function () {
        var _this = this;
        console.log('iii');
        ...
        this.apiService.getPrayers(this.churchName).subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var _a;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, res._id];
                    case 1:
                        _a.prayer_id = _b.sent();
                        if (this.prayer_id) {
                            // getting all prayers of church through ID
                            this.apiService.getAllPrayers(this.prayer_id).subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                var _a, all;
                                var _this = this;
                                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            _a = this;
                                            return [4 /*yield*/, res.result];
                                        case 1:
                                            _a.prayers = _b.sent();
                                            all = this.prayers.slice().reverse();
                                            this.prayers = all.filter(function (x) { return x.is_moderated === true; });
                                            this.prayers.map(function (item) {
                                                item.comments.map(function (items) {
                                                    ...
                                                    if (items.date) {
                                                        ...
                                                        if (time_diff != 0) {
                                                            items.date = _this.appService.getDateTimeFormat(mytime);
                                                        }
                                                        else {
                                                            items.date = _this.appService.getDateTimeFormat(items.date);
                                                        }
                                                    }
                                                });
                                            });
                    ...
                    case 2:
                        ...
                        this.apiService.getPrayers(this.client_id).subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                            var _a;
                            var _this = this;
                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 2:
                                        // this.loader.stopLoading();
                                        this.apiService.getChurchName(this.clientEmail).subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                            var _a;
                                            var _this = this;
                                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                                                switch (_b.label) {
    ...
    PrayerWallPage.prototype.openModal = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.isUserLoggedIn) return [3 /*break*/, 2];
    ...
    PrayerWallPage.prototype.createPrayer = function () {
        var _this = this;
        if (!this.content) {
        ...
        this.loader.presentLoading().then(function () {
            // saving prayer data
            _this.apiService.createPrayer(body, _this.prayer_id).subscribe(function (res) {
                if (res) {
                    // ======= Trigger Notification =============================================================== //
                    var notification_body = {
                        church_id: _this.churchId,
                        title: "NEW POST",
                        message: "There was a new Post in Prayer Wall. Click to view!",
                        timezone: "-300"
                    };
                    _this.apiService.prayerwall_notification_send(JSON.stringify(notification_body)).subscribe(function (result) {
                    });
                    // ======= Trigger Notification ================================================================ //
                    _this.toast.presentToastWithOptions((_this.alertMessage ? _this.alertMessage.request_submitted : 'Your Request has been submitted!'), (_this.alertMessage ? _this.alertMessage.Success : 'Success'), 'success');
                    _this.content = '';
                    _this.getPrayers();
                }
                _this.loader.stopLoading();
    ...
    PrayerWallPage.prototype.iAmPraying = function (id) {
        var _this = this;
        this.loader.presentLoading().then(function () {
            // checking if user has already prayed for the prayer or not
            _this.apiService.iAmPraying(id).subscribe(function (res) {
                if (res.success === true) {
                    _this.toast.presentToastWithOptions((_this.alertMessage ? _this.alertMessage.already_prayed : 'You have already prayed for this prayer'), (_this.alertMessage ? _this.alertMessage.Message : 'Message'), 'success');
                    _this.loader.stopLoading();
                    return;
                }
                // saving i am praying data
                _this.apiService.pray(id).subscribe(function (res) {
                    _this.getPrayers();
                    _this.loader.stopLoading();
                });
            }, function (err) {
    ...
    PrayerWallPage.prototype.loadData = function (event) {
        var _this = this;
        setTimeout(function () {
            event.target.complete();
            // App logic to determine if all data is loaded
            // and disable the infinite scroll
            if (_this.prayers.length == 1000) {
                event.target.disabled = true;
            }
        }, 500);
    };
    PrayerWallPage.prototype.toggleInfiniteScroll = function () {
        this.infiniteScroll.disabled = !this.infiniteScroll.disabled;
    };
    // navigating to back page
    PrayerWallPage.prototype.gotobackPage = function () {
        this.location.back();
    };
    PrayerWallPage.prototype.setAnalytics = function () {
        var dev_id = '';
        var device = 'web';
    ...
    PrayerWallPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.ngOnInit();
        this.event_provider.getChurchData.subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var app_pages, app_pages;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                if (!(Object.keys(res).length === 0)) {
                    app_pages = res.apppages.find(function (x) { return x.name === 'Prayer Wall'; });
    ...
    PrayerWallPage.prototype.ionViewDidLeave = function () {
        this.setAnalytics();
    };
    ...
    PrayerWallPage.ctorParameters = function () { return [
...
//# sourceMappingURL=prayer-wall-prayer-wall-module-es5.js.map