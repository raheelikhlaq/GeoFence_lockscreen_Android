...
let CustomPagePageModule = class CustomPagePageModule {
};
...
let CustomPagePage = class CustomPagePage {
    constructor(route, loader, storage, sermonsService, dom, router, location, common, toast, event_provider, analytics, platform, device, translate, apiService, translateService) {
        this.route = route;
        this.loader = loader;
    ...
    setAnalytics() {
        ...
        let end_time_analytics = moment__WEBPACK_IMPORTED_MODULE_11__();
    ...
    ionViewDidEnter() {
        ...
        this.event_provider.getChurchData.subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (!(Object.keys(res).length === 0)) {
                ...
                this.apiService.getPageData(JSON.stringify(data)).subscribe((response) => {
                    if (response.status) {
                        let app_pages = response.data;
                        if (app_pages[0]) {
                            this.banner_image = app_pages[0].website_banner;
                            ...
                            if (code.search('<a') != -1 && this.platform.is('ios')) {
                                do {
                                    let link = code.match(/data-cke-saved-href="(.*?)"/) ? code.match(/data-cke-saved-href="(.*?)"/) : this.checkLink(code);
                                    if (link && link.length) {
                                        code = code.replace(link[0], '');
                                        code.replace('href=' + link[1], '');
                        ...
                        if (this.ch_id === '994') {
                            if (this.translateService.defaultLang === 'es') {
                                this.html_code = this.dom.bypassSecurityTrustHtml(app_pages[0].html_spanish);
                            }
                        }
                    }
                });
...
//# sourceMappingURL=custom-page-custom-page-module-es2015.js.map