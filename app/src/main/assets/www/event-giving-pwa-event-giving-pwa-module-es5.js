...
var EventGivingPwaPageModule = /** @class */ (function () {
    function EventGivingPwaPageModule() {
    }
    ...
    return EventGivingPwaPageModule;
}());
...
/* harmony import */ var ng_recaptcha__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ng-recaptcha */ "./node_modules/ng-recaptcha/fesm5/ng-recaptcha.js");
...
var EventGivingPwaPage = /** @class */ (function () {
    function EventGivingPwaPage(platform, storage, contribution, loader, toast, Auth, datePipe, _FB, currency, route, router, logoService, navCtrl, common, eventsService, idService, apiService, event_provider, analytics, device, translate, recaptchaV3Service, iab, stripeService) {
        var _this = this;
    ...
    EventGivingPwaPage.prototype.ngOnInit = function () {
    ...
    EventGivingPwaPage.prototype.openurlinbrowser = function (url) {
        this.iab.create(url, "_system");
    };
    EventGivingPwaPage.prototype.verifyRecaptcha = function () {
        var _this = this;
        var current_url = new URL(window.location.href);
        this.recaptchaV3Service.execute("payment_eventPwa").subscribe(function (token) {
            if (token) {
    ...
    EventGivingPwaPage.prototype.clearAllFields = function () {
        this.user = "";
        this.first_name = "";
        this.last_name = "";
        this.last4digits = "";
    ...
    EventGivingPwaPage.prototype.hideHeaderFooter = function () {
    ...
    EventGivingPwaPage.prototype.getUser = function () {
        var _this = this;
        // getting user from local storage
        this.storage.get("user_giving").then(function (val) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    EventGivingPwaPage.prototype.getEvent = function () {
        var _this = this;
        var ch_id = this.ch_id;
        // saving app_pages
    ...
    EventGivingPwaPage.prototype.getCurrency = function (amount) {
        if (amount) {
            var final = this.currency.transform(amount, "", "symbol-narrow", "1.2-2");
            return final.split("$").join("");
        }
    };
    EventGivingPwaPage.prototype.initAmounts = function () {
    ...
    EventGivingPwaPage.prototype.addNewInputField = function (index) {
    ...
    EventGivingPwaPage.prototype.removeInputField = function (i) {
    ...
    EventGivingPwaPage.prototype.changeSliderOnDropdown = function () {
        var _this = this;
    ...
    EventGivingPwaPage.prototype.changeSlider = function () {
        var _this = this;
        if (this.savedSources) {
    ...
    EventGivingPwaPage.prototype.setDate = function () {
        if (this.displayDate) {
            this.date = this.datePipe.transform(this.displayDate, "MM/dd/yyyy");
        }
    };
    EventGivingPwaPage.prototype.setDisplayAmount = function (index) {
    ...
    EventGivingPwaPage.prototype.select_checkbox = function (option, index, inner_index) {
    ...
    EventGivingPwaPage.prototype.addCoverFee = function () {
        var p, k, finalAmount;
    ...
    EventGivingPwaPage.prototype.myFrequency = function (event) {
        if (this.frequency !== "one-time" && this.frequency !== "") {
            this.frequencyon = true;
        }
    };
    EventGivingPwaPage.prototype.getAuthUser = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                // getting user from local storage
    ...
    EventGivingPwaPage.prototype.getGivingType = function () {
        var _this = this;
    ...
    EventGivingPwaPage.prototype.setAmount = function (value, index) {
        var control = this.form.controls.amounts;
    ...
    EventGivingPwaPage.prototype.getDesign = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    EventGivingPwaPage.prototype.getCardDetails = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var body;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    EventGivingPwaPage.prototype.getEpicPayTemplate = function () {
        var _this = this;
        var body = JSON.stringify({
            churchid: this.ch_id,
        });
    ...
    EventGivingPwaPage.prototype.numberOnlyValidation = function (event) {
        var pattern = /[0-9.,]/;
    ...
    EventGivingPwaPage.prototype.expFormat = function (val) {
        if (val.length === 2 && val[val.length - 1] !== "/") {
            this.exp = val + "/";
        }
    };
    EventGivingPwaPage.prototype.createStripePayment = function (bypass_recaptcha, StripeToken) {
        var _this = this;
    ...
    EventGivingPwaPage.prototype.createPayment = function (bypass) {
        var _this = this;
        ...
        if (this.isPaymentMethod === "s" && this.paymentSource === "credit_card") {
            ...
            this.paymentSource === "bank_account") {
            var stripe = window.Stripe(_environments_environment_prod__WEBPACK_IMPORTED_MODULE_15__["environment"].stripe_key);
    ...
    EventGivingPwaPage.prototype.createPaySafeCardPayment = function (bypass_recaptcha, paySafeToken) {
        var _this = this;
        // ADDITIONAL VALIDATION FOR GUEST
        if (this.guest === true && this.guestEmail === "") {
            this.toast.presentToastWithOptions(this.alertMessage
    ...
    EventGivingPwaPage.prototype.logOutUser = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.loader.presentLoading().then(function () {
    ...
    EventGivingPwaPage.prototype.deleteSource = function (i) {
        var _this = this;
        var body = JSON.stringify({
            auth: "Bearer " + this.auth.access_token,
            // source_id: 1867
    ...
    EventGivingPwaPage.prototype.saveLast4Digits = function () {
    ...
    EventGivingPwaPage.prototype.saveLast4BankDigits = function () {
    ...
    EventGivingPwaPage.prototype.gotoLogin = function () {
    ...
    EventGivingPwaPage.prototype.logOut = function () {
        var _this = this;
        this.loader.presentLoading().then(function () {
            _this.Auth.logoutUserGiving();
            _this.ngOnInit();
    ...
    EventGivingPwaPage.prototype.setAnalytics = function () {
        var dev_id = "";
        var device = "app";
        ...
        var end_time_analytics = moment__WEBPACK_IMPORTED_MODULE_18__();
    ...
    EventGivingPwaPage.prototype.ionViewDidEnter = function () {
        var _this = this;
    ...
    EventGivingPwaPage.prototype.ionViewWillLeave = function () {
        this.setAnalytics();
    ...
    EventGivingPwaPage.ctorParameters = function () { return [
...
//# sourceMappingURL=event-giving-pwa-event-giving-pwa-module-es5.js.map