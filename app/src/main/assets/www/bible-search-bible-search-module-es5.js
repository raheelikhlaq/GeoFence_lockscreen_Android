...
var BibleSearchPageModule = /** @class */ (function () {
...
var BibleSearchPage = /** @class */ (function () {
    function BibleSearchPage(modalController, location, _bibleService, event_provider) {
    ...
    BibleSearchPage.prototype.filterModal = function () {
    ...
    BibleSearchPage.prototype.ngOnInit = function () {
        var _this = this;
        // event subscription
        this.event_provider.count.subscribe(function (value) {
            _this.count = value.count;
            _this.filtered_data = value.data;
            // Seperating Old testament data and New Testament Data ============================
            _this.old_data = _this.filtered_data.filter(function (x) {
                var check = x.dam_id.toString();
                if (check[6] === 'O') {
                    return x;
                }
            });
            _this.new_data = _this.filtered_data.filter(function (x) {
                var check = x.dam_id.toString();
                if (check[6] === 'N') {
                    return x;
                }
    ...
    BibleSearchPage.prototype.gotobackPage = function () {
        this.location.back();
    };
    BibleSearchPage.ctorParameters = function () { return [
        ...
        children: [
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: function () { return __webpack_require__.e(/*! import() | teachings-search-list-teachings-search-list-module */ "teachings-search-list-teachings-search-list-module").then(__webpack_require__.bind(null, /*! ../teachings-search-list/teachings-search-list.module */ "./src/app/teachings-search-list/teachings-search-list.module.ts")).then(function (m) { return m.TeachingsSearchListPageModule; }); }
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        ...
                        loadChildren: function () {
                            return __webpack_require__.e(/*! import() | bible-search-list-bible-search-list-module */ "bible-search-list-bible-search-list-module").then(__webpack_require__.bind(null, /*! ../bible-search-list/bible-search-list.module */ "./src/app/bible-search-list/bible-search-list.module.ts")).then(function (m) { return m.BibleSearchListPageModule; });
                        }
                    }
                ]
            },
...
var BibleSearchRouterModule = /** @class */ (function () {
    function BibleSearchRouterModule() {
    }
    ...
    return BibleSearchRouterModule;
}());
...
//# sourceMappingURL=bible-search-bible-search-module-es5.js.map