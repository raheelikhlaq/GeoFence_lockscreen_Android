...
var ReportNowPageModule = /** @class */ (function () {
    function ReportNowPageModule() {
    }
...
var ReportNowPage = /** @class */ (function () {
    function ReportNowPage(storage, event_provider, loader, toast, api, router, location, translate) {
    ...
    // ZB changes start
    ReportNowPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ReportNowPage.prototype.getUser = function () {
        var _this = this;
    ...
    ReportNowPage.prototype.onReportSubmit = function () {
        var _this = this;
        if (this.email === '' || !(this.email.match("[a-zA-Z0-9.-_]{1,}@[a-zA-Z.-]{2,}[.]{1}[a-zA-Z]{3,}"))) {
            ...
            this.loader.presentLoading().then(function () {
                _this.api.reportFunction(body_1).subscribe(function (res) {
                    if (res.status) {
                        _this.loader.stopLoading();
                        _this.toast.presentToastWithOptions('Reported Successfully', 'Thanks', 'success');
                        // this.router.navigate(['/home/'+ this.ch_id]);
                        //  this.location.back();
                        //  console.log('status is: ', res);
                    }
                    else {
                        _this.toast.presentToastWithOptions('Error', 'Something Went Wrong', 'warning');
                    }
                });
    ...
    ReportNowPage.prototype.onKeyForSubject = function (event) {
        this.divClassForSubject = '';
    };
    ReportNowPage.prototype.onKeyForEmail = function (event) {
        this.divClassForEmail = '';
    };
    ReportNowPage.prototype.onKeyForDescription = function (event) {
        this.divClassForDescription = '';
    };
    ReportNowPage.prototype.onKeyForCategory = function (event) {
        if (this.category !== '') {
            this.divClassForCategory = '';
        }
    };
    ReportNowPage.prototype.gotobackPage = function () {
        this.location.back();
    };
    ReportNowPage.prototype.onFileSelected = function (event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var file, reader, toBase64, _a;
            var _this = this;
                    ...
                    case 0:
                        ...
                        toBase64 = function (file) { return new Promise(function (resolve, reject) {
                            ...
                            reader.onload = function () {
                                _this.imageSrc = reader.result; // Set the imageSrc variable
...
//# sourceMappingURL=report-now-report-now-module-es5.js.map