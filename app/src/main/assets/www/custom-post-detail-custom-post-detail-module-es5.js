...
var CustomPostDetailPageModule = /** @class */ (function () {
    function CustomPostDetailPageModule() {
    }
    ...
    return CustomPostDetailPageModule;
}());
...
var CustomPostDetailPage = /** @class */ (function () {
    function CustomPostDetailPage(idService, route, loader, storage, socialSharing, sermonsService, router, eventsService, apiService, toast, 
    ...
    CustomPostDetailPage.prototype.ionViewDidEnter = function () {
        this.getUser();
        this.event_provider.hidefooter(true, 'other');
    };
    CustomPostDetailPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    CustomPostDetailPage.prototype.getUser = function () {
        var _this = this;
    ...
    CustomPostDetailPage.prototype.getDBPost = function () {
        var _this = this;
        var self = this;
        var refresh_comments = false;
        var body = {
        ...
        this.loader.presentLoading().then(function () {
            _this.sermonsService.getCMSSermonPost(body).subscribe(function (res) {
                self.loader.stopLoading();
                var md5 = __webpack_require__(/*! md5 */ "./node_modules/md5/md5.js");
                var data = res.sermons;
                ...
                // this.setComments();
                _this.title = self.note_detail.title;
                _this.pubDate = self.note_detail.date ? self.note_detail.date : self.note_detail.created_at;
                if (self.note_detail) {
                    if (refresh_comments === false) {
                        ...
                        if (self.inner_html_content && self.inner_html_content.includes("<img width=")) {
                            ...
                            if (self.inner_html_content.includes("srcset=")) {
                                var link_1 = self.inner_html_content.match(/srcset="(.*?)"/);
                                self.inner_html_content = self.inner_html_content.replace(link_1[0], '');
                            }
                            ...
                            if (self.inner_html_content !== "" && self.inner_html_content !== null && self.inner_html_content.includes("s3.wasabisys.com") && Object(_angular_common__WEBPACK_IMPORTED_MODULE_10__["formatDate"])(self.note_detail.created_at, 'yyyy-MM-dd', 'en_US') >= '2023-05-29') {
                                ...
                                var abc = self.inner_html_content.split("/");
                                ...
                                var new_link = self.inner_html_content.replace(folder_name, _this.deviceType);
                        ...
                        if (self.inner_html_content.search('<a') != -1) {
                            ...
                            do {
                                var link_2 = _this.checkLink(self.inner_html_content);
                                self.inner_html_content = self.inner_html_content.replace(link_2[0], '');
                                self.inner_html_content.replace('href=' + link_2[1], '');
                                var new_bypassLink = link_2[1];
                        ...
                        if (self.note_detail.comments != '[]') {
                            _this.comments = JSON.parse(self.note_detail.comments);
                            _this.setComments();
                        }
                    }
                ...
                var link = self.note_detail.link ? self.note_detail.link : '';
                link = link.split('//')[1];
    ...
    CustomPostDetailPage.prototype.getNotes = function (url, refresh_comments) {
        var _this = this;
        if (refresh_comments === void 0) { refresh_comments = false; }
        var self = this;
        this.loader.presentLoading().then(function () {
                ...
                if (self.note_detail) {
                    if (refresh_comments === false) {
                        ...
                        if (self.inner_html_content && self.inner_html_content.includes("<img width=")) {
                            ...
                            self.inner_html_content = self.inner_html_content.replace(/(height)="\d*"\s/, '');
                            if (self.inner_html_content.includes("srcset=")) {
                                var link = self.inner_html_content.match(/srcset="(.*?)"/);
                        ...
                        if (self.inner_html_content.search('<a') != -1) {
                            do {
                                var link = _this.checkLink(self.inner_html_content);
                                self.inner_html_content = self.inner_html_content.replace(link[0], '');
    ...
    CustomPostDetailPage.prototype.setComments = function () {
        var _this = this;
        this.comments.map(function (item) {
            ...
            var mytime = moment__WEBPACK_IMPORTED_MODULE_16__(item.comment_time);
            ...
            // }
            var localTimeZone = moment__WEBPACK_IMPORTED_MODULE_16__["tz"].guess(true);
            mytime = moment__WEBPACK_IMPORTED_MODULE_16__(item.comment_time).tz(localTimeZone);
            mytime = _this.appService.getDateTimeFormat(mytime);
            var time_diff = moment__WEBPACK_IMPORTED_MODULE_16__().utcOffset(); // in minutes
            if (time_diff != 0) {
    ...
    CustomPostDetailPage.prototype.refresh_comments = function () {
    ...
    CustomPostDetailPage.prototype.presentPopover = function (ev) {
    ...
    CustomPostDetailPage.prototype.create_comment = function () {
        var _this = this;
        if (!this.comment) {
            ...
            if (this.isLoggedIn) {
                ...
                if (this.is_wordpress_enable === 'true') {
                    this.sermonsService.create_custom_post_comment_cms(body).subscribe(function (res) {
                ...
                if (this.is_wordpress_enable === 'false') {
                    this.sermonsService.create_custom_post_comment(body).subscribe(function (res) {
                        // refreshing sermons data after comment added
                        _this.refresh_comments();
                        _this.comment = '';
                    });
    ...
    CustomPostDetailPage.prototype.checkLink = function (code) {
    ...
    CustomPostDetailPage.prototype.copyLink = function () {
    ...
    CustomPostDetailPage.prototype.gotobackPage = function () {
        this.location.back();
    };
    CustomPostDetailPage.prototype.openInBrowser = function (url) {
    ...
    CustomPostDetailPage.prototype.openTwitter = function (url) {
        var _this = this;
        this.socialSharing.shareViaTwitter(url).then(function (data) {
        }, function (error) {
            _this.socialSharing.share(url);
        });
    };
    CustomPostDetailPage.prototype.openFacebook = function (url) {
        var _this = this;
        if (this.platform.is('android')) {
            this.socialSharing.shareVia('com.facebook.katana', url).then(function (data) {
            }, function (error) {
                _this.socialSharing.share(url);
            });
        }
        else if (this.platform.is('ios')) {
            this.socialSharing.shareViaFacebook(url).then(function (data) {
            }, function (error) {
                _this.socialSharing.share(url);
            });
        }
    };
    CustomPostDetailPage.ctorParameters = function () { return [
...
//# sourceMappingURL=custom-post-detail-custom-post-detail-module-es5.js.map