...
let FormsPage = class FormsPage {
    constructor(event_provider, wordPressSerice, loader, location, route, qcs, toast, dom, common, translate, router) {
    ...
    onCheckBoxChange(ev, question, index) {
        question.value[index];
    }
    getForm() {
        this.number_of_quize_fields = 0;
        this.wordPressSerice.getQuestions({ ch_id: this.ch_id, id: this.slug }).subscribe((res) => {
    ...
    onSubmit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.wordPressSerice.saveForm(body).subscribe((res) => {
    ...
    uploadFiles(files, index, question) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            let base64 = yield toBase64(files[0]);
            let data = {
                file: base64
            };
...
//# sourceMappingURL=modules-forms-forms-forms-module-es2015.js.map