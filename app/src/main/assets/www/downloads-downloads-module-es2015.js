...
let DownloadsPage = class DownloadsPage {
    constructor(ft, file, platform, dowloadService, dom, loader, location, storage, toast, event_provider, documentviewer, fileOpener, iab, common) {
        this.ft = ft;
        this.file = file;
    ...
    openPdf(newBypassLink) {
        ...
        if (this.platform.is('cordova')) {
            ...
            transfer.download(newBypassLink, `${path}myfile.pdf`).then((res) => {
