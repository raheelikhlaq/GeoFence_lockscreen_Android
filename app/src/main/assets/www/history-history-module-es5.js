...
var HistoryPage = /** @class */ (function () {
    function HistoryPage(location, darkModeService, apiService, storage, common, device, appService, platform, modalController, event_provider, router, firebasex) {
    ...
    HistoryPage.prototype.ionViewWillEnter = function () {
        ...
        this.event_provider.getChurchData.subscribe(function (data) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var res, dev_id;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                if (!(Object.keys(data).length === 0)) {
                    ...
                    dev_id = localStorage.getItem('device_id');
                    if (dev_id !== null) {
                        this.is_mobile = true;
    ...
    HistoryPage.prototype.getNotifications = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.apiService.getNotifications(body).subscribe(function (res) {
                    if (res && res.status) {
                        _this.notifications = res.notifications.filter(function (x) { return x.status === 'true'; }).reverse();
                    }
                });
                return [2 /*return*/];
            });
    ...
    HistoryPage.prototype.removeNotification = function (id) {
        var _this = this;
        this.apiService.removeNotification(id).subscribe(function (res) {
            if (res) {
    ...
    HistoryPage.prototype.clearHistory = function () {
        ...
        this.apiService.clearHistory(body).subscribe(function (res) {
            if (res.status) {
                _this.getNotifications();
            }
        });
    ...
    HistoryPage.prototype.goToPage = function (notification) {
        if (notification.url && notification.url !== 'null') {
            var item = JSON.parse(notification.url);
