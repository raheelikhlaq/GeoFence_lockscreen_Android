...
/* harmony import */ var _question_base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./question-base */ "./src/app/modules/forms/common/question-base.ts");
...
let ChatService = class ChatService {
    ...
    getChats(id, uid) {
        if (uid != 'guest') {
            let api = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_end_point + '/chatroom/conversation/' + id + '/' + uid;
            return this.http.get(api);
        }
        else {
            let api = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_end_point + '/chatroom/conversation/' + id;
            return this.http.get(api);
        }
    }
    save_message(body) {
        let api = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_end_point + '/chatroom/message';
        return this.http.post(api, JSON.parse(body), { headers: this._headers });
    }
    get_messages(id) {
        let api = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_end_point + '/chatroom/messages/' + id;
        return this.http.get(api);
    }
    get_bible_messages(body) {
        let api = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_end_point + '/chatroom/biblegetmessages';
        return this.http.post(api, JSON.parse(body), { headers: this._headers });
    }
    savebiblemessage(body) {
        let api = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_end_point + '/chatroom/savebiblemessage';
        return this.http.post(api, JSON.parse(body), { headers: this._headers });
    }
    savegroupmember(body) {
        let api = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_end_point + '/chatroom/groupmember';
        return this.http.post(api, JSON.parse(body), { headers: this._headers });
    }
};
...
let MyContributionService = class MyContributionService {
    constructor(http, storage) {
        this.http = http;
        this.storage = storage;
        this._headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
    ...
    getGivingType(body) {
        let api = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_end_point + '/givings/givingtype';
        return this.http.post(api, JSON.parse(body), { headers: this._headers });
    }
    getPaymentDetails(body) {
        let api = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_end_point + '/givings/get_donorsources';
        return this.http.post(api, JSON.parse(body), { headers: this._headers });
    }
    getEpicPayTemplate(body) {
        let api = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_end_point + '/givings/get_eptpl';
        return this.http.post(api, JSON.parse(body), { headers: this._headers });
    }
    removePaymentSource(body) {
        let api = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_end_point + '/givings/delete_source';
        return this.http.post(api, JSON.parse(body), { headers: this._headers });
    }
    makePayment(body, is_guest) {
        let api;
        if (is_guest === false) {
    ...
    createPledge(body) {
        let api = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_end_point + '/givings/createpledge';
        return this.http.post(api, JSON.parse(body), { headers: this._headers });
    }
    createPledge_guest(body) {
        let api = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_end_point + '/givings/guestcreatepledge';
        return this.http.post(api, JSON.parse(body), { headers: this._headers });
    }
    checkCaptcha(token) {
        let api = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_end_point + '/givings/checkCaptcha/' + token;
        return this.http.get(api);
    }
};
MyContributionService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
    { type: _ionic_storage__WEBPACK_IMPORTED_MODULE_4__["Storage"] }
];
...
let WordPressService = class WordPressService {
    ...
    getContent(data) {
        let api = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].api_end_point + '/Content/content';
    ...
    getQuestions(data) {
        ...
        let api = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].api_end_point + '/content/formsData';
        return this.http.post(api, data);
        // return of(questions.sort((a, b) => a.order - b.order));
    }
    saveForm(data) {
        let api = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].api_end_point + '/content/saveForm';
        return this.http.post(api, data);
    }
    saveFiles(data) {
        let file_headers;
        ...
        let api = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].api_end_point + '/contentcms/uploadFile';
