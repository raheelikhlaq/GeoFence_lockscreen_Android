...
var EventsPage = /** @class */ (function () {
    function EventsPage(route, eventsService, storage, loader, router, toast, datepipe, location, poCtrl, common, dom, appService, analytics, eventsCall, platform, device, translate, event_provider) {
        var _this = this;
        this.route = route;
    ...
    EventsPage.prototype.ngOnInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.eventsCall.subscribe('is_home_enable', function (is_home_enable) {
                    _this.enable_home = is_home_enable;
                });
                if (!this.enable_home) {
    ...
    EventsPage.prototype.getUser = function () {
        var _this = this;
    ...
    EventsPage.prototype.getDBEvents = function (event) {
        var _this = this;
        ...
        var cmsevents;
        this.eventsService.getCMSEvents(body).subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var i, obj, keys, j, key, abc, folder_name, new_link;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.total_page_in_pagination = res['pages'];
                cmsevents = res['events'];
                // Saving City in Array
                for (i = 0; i < cmsevents.length; i++) {
                    ...
                    for (j = 0; j < keys.length; j++) {
                        ...
                        if (keys[j].includes("featuredimageurl")) {
                            ...
                            if (cmsevents[i].photo !== "" && cmsevents[i].photo !== null && cmsevents[i].photo.includes("s3.wasabisys.com") && Object(_angular_common__WEBPACK_IMPORTED_MODULE_7__["formatDate"])(cmsevents[i].created_at, 'yyyy-MM-dd', 'en_US') >= Object(_angular_common__WEBPACK_IMPORTED_MODULE_7__["formatDate"])(new Date(), 'yyyy-MM-dd', 'en_US')) {
                                ...
                                new_link = cmsevents[i].photo.replace(folder_name, this.deviceType);
                ...
                if (this.filtered_events) {
                    this.filtered_events.forEach(function (event) {
                        var new_timeZone = '';
                        ...
                        if (new_timeZone !== '') {
                            var mytm = moment__WEBPACK_IMPORTED_MODULE_13__(event.start_date).tz(new_timeZone);
                            var x = mytm.format('YYYY-MM-DD HH:mm:ss').toString();
                            var mytime = moment__WEBPACK_IMPORTED_MODULE_13__(x);
                            var time_diff = moment__WEBPACK_IMPORTED_MODULE_13__().utcOffset(); // in minutes
                            if (time_diff != 0) {
                                event.startdate = _this.appService.getDateFormat(mytime);
                                event.starttime = _this.appService.getTimeFormat(mytime);
                            ...
                            var mytm = moment__WEBPACK_IMPORTED_MODULE_13__(event.start_date);
                            var time = event.starttime_hrs + ':' + event.starttime_mins + ':' + event.starttime_ampm;
                            var x = mytm.format('YYYY-MM-DD').toString();
                            x = x + ' ' + time;
                            var mytime = moment__WEBPACK_IMPORTED_MODULE_13__(x);
                            var time_diff = moment__WEBPACK_IMPORTED_MODULE_13__().utcOffset(); // in minutes
                            if (time_diff != 0) {
    ...
    EventsPage.prototype.settingsPopover = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var self, popover;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        self = this;
                        return [4 /*yield*/, self.poCtrl.create({
                            ...
                            if (res.data) {
                                if (res.data.date && res.data.func) {
                                    if (res.data.func === 'filter') {
                                        _this.filterDate = res.data.date;
                                        _this.check();
                                    }
                                }
                                if (res.data.func === 'discard') {
                                    _this.discard_filter();
                                }
                            }
                        });
    ...
    EventsPage.prototype.check = function () {
        var _this = this;
        if (this.filterDate) {
            this.filterDate = this.datepipe.transform(this.filterDate, 'yyyy-MM-dd');
            if (this.dashboard_mode) {
                this.filtered_events = this.events.filter(function (x) { return _this.datepipe.transform(x.start_date, 'yyyy-MM-dd') === _this.filterDate; });
                this.event_area_country = [];
                this.event_area_city = [];
                this.cancel_filter = true;
            }
            else if (this.church_mode) {
                this.church_filtered_events = this.church_events.filter(function (x) { return _this.datepipe.transform(x.start_date, 'yyyy-MM-dd') === _this.filterDate; });
                this.cancel_filter = true;
            }
            else {
                this.filtered_events = this.events.filter(function (x) { return _this.datepipe.transform(x.start_date, 'yyyy-MM-dd') === _this.filterDate; });
    ...
    // removing filter
    EventsPage.prototype.discard_filter = function () {
        if (this.dashboard_mode) {
    ...
    EventsPage.prototype.addMoreData = function () {
        var loop = this.count;
    ...
    EventsPage.prototype.getEvents = function () {
        ...
        if (this.event_dashboard_url.includes("calendar.google.com")) {
            ...
            this.eventsService.getGoogleEvents(_body).subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    this.total_page_in_pagination = res['pages'];
            ...
            if (this.external_server) {
                ...
                this.eventsService.getEvents(this.event_dashboard_url).subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                    var _a;
            ...
            this.eventsService.getEventsFromChurchId(this.ch_id).subscribe(function (res) {
                if (res) {
                    _this.events = res.events[0];
                    _this.filtered_events = _this.events;
                    _this.setEventsDateTimeZone();
                }
                _this.loader.stopLoading();
                _this.dataLoaded = true;
            }, function (err) {
    ...
    EventsPage.prototype.setEventsData = function (is_loadData) {
            ...
            for (var j = 0; j < keys.length; j++) {
                ...
                if (keys[j].includes("ATTACH")) {
                    ...
                    if (this.events[i].photo !== "" && this.events[i].photo !== null && this.events[i].photo.includes("s3.wasabisys.com") && Object(_angular_common__WEBPACK_IMPORTED_MODULE_7__["formatDate"])(this.events[i].created_at, 'yyyy-MM-dd', 'en_US') >= '2023-05-29') {
                        var abc = this.events[i].photo.split("/");
                        ...
                        var new_link = this.events[i].photo.replace(folder_name, this.deviceType);
    ...
    EventsPage.prototype.setEventsDateTimeZone = function () {
        var _this = this;
        if (this.filtered_events) {
            this.filtered_events.forEach(function (event) {
                var new_timeZone = '';
    ...
    EventsPage.prototype.setDashboardEventsData = function (is_ical) {
        if (this.events !== undefined) {
            for (var i = 0; i < this.events.length; i++) {
                // REMOVING "/" FROM EVENTS SUMMARY
    ...
    EventsPage.prototype.loadData = function (event) {
        var _this = this;
        ...
        if (this.page <= this.total_page_in_pagination) {
            ...
            if (this.is_wordpress_enable === true) {
                ...
                this.eventsService.getGoogleEvents(_body).subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                    ...
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                        this.events = res['events'];
                        index = Object.keys(this.events)[0];
                        ind = parseInt(index);
    ...
    EventsPage.prototype.openDetail = function (data) {
        var md5 = __webpack_require__(/*! md5 */ "./node_modules/md5/md5.js");
        var hashed_id = md5(data); // hashing ID before sending for security purpose
        this.router.navigate(['event-detail', {
                event_id: hashed_id,
                mode: "church"
            }]);
    };
    EventsPage.prototype.isDateValid = function (date) {
    ...
    EventsPage.prototype.open_Detail_dashboard = function (data, index) {
        if (this.church_mode === true) {
            this.openDetail(data);
        }
        else {
            var md5 = __webpack_require__(/*! md5 */ "./node_modules/md5/md5.js");
            var hashed_id = this.is_wordpress_enable ? this.events[index].id : md5(data); // hashing ID before sending for security purpose
    ...
    EventsPage.prototype.bypass_url = function (image) {
        // sanitizing image url for security purpose
        return this.dom.bypassSecurityTrustResourceUrl(image);
    };
    EventsPage.prototype.gotobackPage = function () {
        var block_page = this.common.is_home_enable.next_page;
        if (block_page !== "Events") {
            this.location.back();
        }
    };
    EventsPage.prototype.setAnalytics = function () {
        var dev_id = '';
        var device = 'web';
    ...
    EventsPage.prototype.ionViewDidLeave = function () {
        this.setAnalytics();
    };
