...
var StationPageModule = /** @class */ (function () {
    function StationPageModule() {
    }
...
var StationPage = /** @class */ (function () {
    // allSermons: any;
    // latestSermon: any;
    // popularSermons: any;
    // recentSermons: any;
    ...
    function StationPage(storage, loader, sermonsService, router, location, toast, common, event_provider, platform, device, analytics, translate, menu, route, apiService) {
        var _this = this;
        ...
        this.storage.get('theme').then(function (res) {
            // getting app_pages
            var body = JSON.stringify({ id: res.ch_id });
            _this.common.getTheme(body).subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                ...
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    ...
                    page = res.apppages.filter(function (x) { return x.page_type === 'page' && x.id === _this.route.snapshot.queryParams.page_id; });
                    if (page.length > 0) {
    ...
    StationPage.prototype.gotobackPage = function () {
        if (this.ch_id === '1000') {
            this.menu.toggle();
        }
        else {
    ...
    StationPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.ngOnInit();
        this.event_provider.getChurchData.subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                if (!(Object.keys(res).length === 0)) {
                    id = this.route.snapshot.queryParams.page_id;
    ...
    StationPage.prototype.ionViewDidEnter = function () {
        this.pageno = 1;
        this.event_provider.hidefooter(true, 'other');
    };
    StationPage.prototype.ngOnInit = function () {
    };
    StationPage.prototype.getStations = function (ev) {
        var _this = this;
        if (ev) {
            this.pageno = this.pageno + 1;
            this.apiService.getStations(this.pageno, this.ch_id).subscribe(function (res) {
                var _a;
                console.log(res);
                ev.target.complete();
                if (res.status) {
                    (_a = _this.stations).push.apply(_a, res.data);
                }
            }, function (err) {
                console.log(err);
            });
    ...
    StationPage.prototype.playAudio = function (url) {
        this.event_provider.setAudioUrl({ url: url, autoPlay: true, dateTime: Date.now() });
    };
    StationPage.prototype.makeFavourite = function (church_id) {
        var _this = this;
        this.apiService.makeStationFavourite(this.userId, church_id).subscribe(function (res) {
            console.log(res);
            if (res.status) {
                _this.getStations();
            }
    ...
    StationPage.prototype.hasAudioLink = function (link) {
        if (this.ch_id == '1124') {
    ...
    StationPage.ctorParameters = function () { return [
...
//# sourceMappingURL=station-station-module-es5.js.map