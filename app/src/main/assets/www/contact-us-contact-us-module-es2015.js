...
let ContactUsPage = class ContactUsPage {
    constructor(location, storage, common, event_provider, analytics, platform, device, translate, dom, iab) {
            ...
            if (res) {
                ...
                this.common.getTheme(body).subscribe((theme) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                    ...
                    if (theme && theme.status) {
                        ...
                        let page = theme.apppages.find(x => x.activated === 'true' && x.name === "Contact Us");
                        let myPage = page;
    ...
    ionViewWillEnter() {
        ...
        this.event_provider.getChurchData.subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (!(Object.keys(res).length === 0)) {
                // asking for password
                let app_pages = res.apppages.find(x => x.name === 'Contact Us');
