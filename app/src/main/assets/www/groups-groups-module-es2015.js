...
let GroupsPage = class GroupsPage {
    constructor(api, storage, loader, router, toast, location, common, analytics, event_provider, platform, device, translate) {
        this.api = api;
            ...
            this.storage.get('theme').then(theme => {
                ...
                this.common.getTheme(body).subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                    if (res) {
                        ...
                        let app_pages = res.apppages.filter(x => x.name === 'Groups');
                        if (app_pages[0]) {
        ...
        this.storage.get('theme').then((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (res) {
                ...
                if (this.ch_id) {
                    ...
                    this.api.getAllGroups(this.ch_id).subscribe((res) => {
    ...
    ionViewWillEnter() {
        ...
        this.event_provider.getChurchData.subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (!(Object.keys(res).length === 0)) {
                // asking for password
                let app_pages = res.apppages.find(x => x.name === 'Groups');
