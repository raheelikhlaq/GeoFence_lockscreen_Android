...
let NewTestamentPageModule = class NewTestamentPageModule {
};
...
let NewTestamentPage = class NewTestamentPage {
    constructor(_bibleService, loader, toast, router, storage, event_provider, route, translate, common, audioService) {
        ...
        this.event_provider.updateNewTest.subscribe(value => {
...
NewTestamentPage.ctorParameters = () => [
...
//# sourceMappingURL=new-testament-new-testament-module-es2015.js.map