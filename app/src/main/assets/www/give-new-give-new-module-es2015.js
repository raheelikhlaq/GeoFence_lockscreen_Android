...
let GiveNewPageModule = class GiveNewPageModule {
};
...
/* harmony import */ var ngx_stripe__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ngx-stripe */ "./node_modules/ngx-stripe/fesm2015/ngx-stripe.js");
...
let GiveNewPage = class GiveNewPage {
    constructor(storage, contribution, loader, toast, Auth, datePipe, _FB, currency, route, router, logoService, navCtrl, apiService, idService, event_provider, analytics, platform, device, translate, recaptchaV3Service, iab, fb, stripeService, stripeBank, common) {
                ...
                let interval = setInterval(() => {
                    ...
                    if (this.giving_theme.app_style) {
                        ...
                        if (app_style === "2") {
                            ...
                            if (theme_color === "") {
                                this.themecolor = "969696";
                                this.cardNumberOptions.style.base.color = "#ffffff";
                            }
                            if (this.giving_theme.dark_logo) {
                                this.giving_logo = this.giving_theme.dark_logo;
                            ...
                            if (theme_color === "") {
                                this.cardNumberOptions.style.base.color = "#fff";
                                this.themecolor = "969696";
                            }
                            if (this.giving_theme.logo) {
                                this.giving_logo = this.giving_theme.logo;
                                // calling event to update logo
    ...
    ionViewWillEnter() {
        ...
        this.event_provider.getChurchData.subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (!(Object.keys(res).length === 0)) {
                // asking for password
                let app_pages = res.apppages.find(x => x.name === '');
    ...
    verifyRecaptcha() {
        this.loader.presentLoading().then(() => {
            let current_url = new URL(window.location.href);
            this.recaptchaV3Service.execute("payment_giveNew").subscribe((token) => {
                if (token) {
    ...
    createPayment(bypass) {
        ...
        if (this.isPaymentMethod === "s" && this.paymentSource === "credit_card") {
            ...
            this.paymentSource === "bank_account") {
            const stripe = window.Stripe(src_environments_environment__WEBPACK_IMPORTED_MODULE_23__["environment"].stripe_key);
...
//# sourceMappingURL=give-new-give-new-module-es2015.js.map