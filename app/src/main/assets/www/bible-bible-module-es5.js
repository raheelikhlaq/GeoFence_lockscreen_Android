        ...
        children: [
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: function () { return __webpack_require__.e(/*! import() | old-testament-old-testament-module */ "old-testament-old-testament-module").then(__webpack_require__.bind(null, /*! ../old-testament/old-testament.module */ "./src/app/old-testament/old-testament.module.ts")).then(function (m) { return m.OldTestamentPageModule; }); }
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        ...
                        loadChildren: function () {
                            return __webpack_require__.e(/*! import() | new-testament-new-testament-module */ "new-testament-new-testament-module").then(__webpack_require__.bind(null, /*! ../new-testament/new-testament.module */ "./src/app/new-testament/new-testament.module.ts")).then(function (m) { return m.NewTestamentPageModule; });
                        }
                    }
                ]
            },
...
var BibleTabsRouterModule = /** @class */ (function () {
    function BibleTabsRouterModule() {
    }
...
var BiblePageModule = /** @class */ (function () {
...
var BiblePage = /** @class */ (function () {
    function BiblePage(route, loader, storage, sermonsService, dom, router, location, common, toast, _bibleService, analytics, event_provider, platform, device, alertController, translate, modalController, audioService) {
        var _this = this;
        this.route = route;
        this.loader = loader;
        ...
        this.event_provider.updateBibleLanguage.subscribe(function (value) {
            var b = localStorage.getItem('bible') ? JSON.parse(localStorage.getItem('bible')) : '';
            if (b) {
                if (b.language) {
                    _this.selected_language = b.language;
                }
                if (b.volume) {
                    _this.selected_volume = b.volume;
                }
            }
            var bible_obj = {
                language: _this.selected_language,
            ...
            //this.set_dam_id_lang();
            _this.ngOnInit();
            _this.modal_is_on = false;
        });
    }
    BiblePage.prototype.ionViewWillEnter = function () {
        var _this = this;
        ...
        this.event_provider.getChurchData.subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                if (!(Object.keys(res).length === 0)) {
                    app_pages = res.apppages.find(function (x) { return x.name === 'Bible'; });
    ...
    BiblePage.prototype.ngOnInit = function () {
                                ...
                                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                    if (res) {
                                        ...
                                        this.storage.get('app_pages').then(function (res) {
                                            var app_pages = res.filter(function (x) { return x.name === 'Bible'; });
                                            if (app_pages[0]) {
    ...
    BiblePage.prototype.openTranslationsModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    BiblePage.prototype.selectvolumealert = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    BiblePage.prototype.novolumealert = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    BiblePage.prototype.getUser = function () {
        var _this = this;
    ...
    //                 // });
    //     }
    BiblePage.prototype.set_dam_id_version = function () {
        var bible_obj = {
            language: this.selected_language,
            volume: this.selected_volume
        };
    ...
    BiblePage.prototype.showLoader = function () {
        var _this = this;
    ...
    BiblePage.prototype.gotobackPage = function () {
        this.location.back();
    };
    BiblePage.prototype.setAnalytics = function () {
        var dev_id = '';
        var device = 'web';
    ...
    BiblePage.ctorParameters = function () { return [
...
//# sourceMappingURL=bible-bible-module-es5.js.map