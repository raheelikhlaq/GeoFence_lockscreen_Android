...
var SignupPage = /** @class */ (function () {
    function SignupPage(route, router, idService, storage, Auth, loader, toast, 
    ...
    SignupPage.prototype.getCountryCodes = function () {
        var _this = this;
    ...
    SignupPage.prototype.getDesign = function () {
    ...
    SignupPage.prototype.registerUser = function () {
        ...
        var body;
        var loginData = JSON.parse(this.loginData);
        if (this.fromEmail === true) {
            body = JSON.stringify({
        ...
        this.loader.presentLoading().then(function () {
            ...
            _this.Auth.registerUser(body).subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                var token, data, pageName;
    ...
    SignupPage.prototype.updateTokenOnServer = function () {
    ...
    SignupPage.prototype.nextPage = function (step) {
    ...
    SignupPage.prototype.step1Validation = function () {
