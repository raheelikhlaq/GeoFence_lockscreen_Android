...
let WheatherPageModule = class WheatherPageModule {
};
...
let WheatherPage = class WheatherPage {
    constructor(weatherService, platform, admobPro, location, event_provider, loader, dom, geolocation, diagnostic, openNativeSettings, common) {
    ...
    ionViewWillEnter() {
        ...
        this.event_provider.getChurchData.subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (!(Object.keys(res).length === 0)) {
                // asking for password
                let app_pages = res.apppages.find(x => x.name === 'Weather');
    ...
    getWeather(weather_degree) {
        ...
        this.geolocation.getCurrentPosition().then((position) => {
            ...
            let self = this;
            self.weatherService.getWeather(lat, lng, weather_degree).subscribe((data) => {
            ...
            console.log(this.diagnostic.permission.ACCESS_FINE_LOCATION);
            this.diagnostic.requestLocationAuthorization('always').then(res => {
                console.log(res);
            });
            if (this.diagnostic.permission.ACCESS_FINE_LOCATION) { }
            this.diagnostic.permission.ACCESS_COARSE_LOCATION;
        });
    }
    getWeeklyWeather(weather_degree) {
        navigator.geolocation.getCurrentPosition((position) => {
            let lat = position.coords.latitude;
            let lng = position.coords.longitude;
            this.weatherService.getWeeklyWeather(lat, lng, weather_degree).subscribe((data) => {
    ...
    getWeatherMap() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.weatherService.getWeatherMap()
                ...
                this.weimg = 'data:image/png;base64,' + encode(bytes);
...
//# sourceMappingURL=wheather-wheather-module-es2015.js.map