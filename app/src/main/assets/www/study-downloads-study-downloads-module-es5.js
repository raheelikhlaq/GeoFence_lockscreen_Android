...
var StudyDownloadsPageModule = /** @class */ (function () {
    function StudyDownloadsPageModule() {
    }
    ...
    return StudyDownloadsPageModule;
}());
...
var StudyDownloadsPage = /** @class */ (function () {
    function StudyDownloadsPage(modalController, location, audioService, service, router, actionSheetController, toast, downloadService, platform, storage, socialSharing, _bibleService) {
    ...
    StudyDownloadsPage.prototype.ngOnInit = function () {
    ...
    StudyDownloadsPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.audioService.downloadedStudy = new Array(this.downloadedStudy.length).fill(false);
        if (this.audioService.fromPage == 'study' && this.audioService.audioIndex > -1) {
            this.audioService.downloadedStudy[this.audioService.audioIndex] = true;
    ...
    StudyDownloadsPage.prototype.OpenSharingModal = function (audio) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        flag = (audio.book_id ? audio.book_id : audio.cmp_book_id) ? false : true;
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss()
                            ...
                            if (user.data === 'passenger') {
                                _this.ReadTheBiblePassage(audio);
                            }
                        });
    ...
    StudyDownloadsPage.prototype.gotobackPage = function () {
        this.location.back();
    };
    StudyDownloadsPage.prototype.playTodayStudy = function (isplay, audio, index) {
        var _this = this;
        ...
        if (this.audioService.audioUrl == audiourl) {
            ...
            setTimeout(function () {
                ...
                _this.service.image = audio.art_url;
    ...
    StudyDownloadsPage.prototype.openDetail = function (audio) {
        this.router.navigate(['study-download-detail', {
                audioData: JSON.stringify(audio),
            }]);
    };
    StudyDownloadsPage.prototype.shareURL = function (audio) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var actionSheet;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    StudyDownloadsPage.prototype.ReadTheBiblePassage = function (item) {
        console.log(item);
    ...
    StudyDownloadsPage.prototype.getCMPBooks = function (bible_id) {
        var _this = this;
        var self = this;
    ...
    StudyDownloadsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=study-downloads-study-downloads-module-es5.js.map