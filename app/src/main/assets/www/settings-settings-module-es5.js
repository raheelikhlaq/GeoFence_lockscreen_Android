...
var SettingsPage = /** @class */ (function () {
    function SettingsPage(location, darkModeService, statusBar, apiService, storage, common, device, platform, modalController, event_provider, translate, iab, alertController, menu, socialSharing, loader, router, nativeSetting) {
    ...
    SettingsPage.prototype.ngOnInit = function () {
        ...
        this.storage.get('app_url').then(function (res) {
            if (res && res.appStoreUrl) {
                _this.ios_url = res.appStoreUrl;
                _this.android_url = res.playStoreUrl;
            }
        });
        ...
        this.storage.get("theme").then(function (res) {
            if (res) {
                ...
                if (_this.ch_id === '1000') {
                    var lang = JSON.parse(localStorage.getItem('ism_app_language'));
                    _this.lang = lang.name;
                }
                if (_this.ch_id == 1186 || _this.ch_id == '1186') {
                    _this.languages.push("Chinese");
                }
                _this.platform.ready().then(function () {
                    if (localStorage.getItem('device_id')) {
                        _this.device_id = localStorage.getItem('device_id');
                    }
                    if (_this.ch_id == "1265" || _this.ch_id == "54") {
                        _this.languages.push("Chinese");
                        _this.languages.push("Hindi");
                        _this.languages.push("Tamil");
                        _this.languages.push("Telugu");
                    }
                    ...
                    if (_this.is_mobile) {
                        _this.getPrayerWallToggleStatus();
                    }
                    _this.getPrayerWallToggleStatus();
                    _this.getTopics(_this.ch_id);
                });
            }
        });
    ...
    SettingsPage.prototype.openTranslationsModalTwo = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var lang, app_language, modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (localStorage.getItem('ism_app_language')) {
                            lang = JSON.parse(localStorage.getItem('ism_app_language'));
                            this.lang = lang.name;
                        }
                        else {
                            app_language = {
    ...
    SettingsPage.prototype.changeLang = function (lang) {
        var _this = this;
        this.languages.forEach(function (elem) {
            if (lang === elem.lang) {
                _this.translate.setDefaultLang(elem.lang_code);
                var app_language = {
                    code: elem.lang_code,
                    name: elem.lang,
                    bible_id: elem.bible_id,
                ...
                _this.storage.set('app_language', app_language);
                localStorage.setItem('app_language', app_language.code);
                _this.event_provider.changeapplanguage(true);
                document.dir = "ltr";
            }
        });
    };
    // setting mobile mode on toggle change
    SettingsPage.prototype.setMode = function () {
    ...
    SettingsPage.prototype.getTopics = function (ch_id) {
        var _this = this;
        this.apiService.get_topics(ch_id, this.device_id).subscribe(function (res) {
            if (res) {
                if (res.status) {
                    _this.topics = res.topics;
                }
            }
        });
    };
    SettingsPage.prototype.topicToggle = function (topic) {
        var _this = this;
        ...
        this.apiService.topic_subscribe(body).subscribe(function (res) {
            if (res && res.status) {
                _this.getTopics(_this.ch_id);
            }
        });
    ...
    SettingsPage.prototype.setPrayerwallNotifications = function () {
        ...
        this.apiService.prayerwall_notification_subscribe(body).subscribe(function (res) {
            if (res && res.status) {
            }
    ...
    SettingsPage.prototype.getPrayerWallToggleStatus = function () {
        var _this = this;
        // this.loader.presentLoading().then(() => {});
        var body = JSON.stringify({
            church_id: this.ch_id,
        ...
        this.apiService.getPrayerWallToggleStatus(body).subscribe(function (res) {
            if (res && res.status) {
                _this.prayerwall_notofication_enable = res.toggle_value;
            }
            // this.loader.stopLoading();
        }, function (err) {
            // this.loader.stopLoading();
    ...
    SettingsPage.prototype.openabouturlinapp = function (url) {
        // about url
        var link = url;
    ...
    // inside app on page with done button
    SettingsPage.prototype.openshareurlinapp = function () {
        // share url
        var url = "https://pressbible.com/";
        if (this.platform.is('android') || this.platform.is('iphone')) {
    ...
    SettingsPage.prototype.showcontact = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    SettingsPage.prototype.gotobackPage = function () {
        if (this.ch_id === '1000') {
            this.menu.toggle();
        }
        else {
    ...
    SettingsPage.prototype.shareApp = function (ch_id) {
        var _this = this;
        if (ch_id === "1000") {
            this.socialSharing.share('PressBible is an easy way to press into the Word and learn more about the Bible. Download it at, https://pressbible.com').then(function (data) {
            }, function (error) {
            });
        }
        else {
            this.share_text = "Learn_more";
            this.translate.get(this.share_text).subscribe(function (res) {
                _this.share_text = res;
                _this.socialSharing.share(_this.share_text + (_this.android_url ? _this.android_url + '(Play Store) ,' : '') + (_this.ios_url ? _this.ios_url + '(App Store)' : '')).then(function (data) {
                }, function (error) {
                });
            });
        }
    };
    SettingsPage.prototype.locationSetting = function () {
        this.nativeSetting.open('locations').then(function (res) {
            console.log(res);
        }, function (err) {
            console.log(err);
        });
    };
    SettingsPage.prototype.languageSearching = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (res) {
                            ...
                            if (res.data.selectLang) {
                                _this.translate.setDefaultLang(res.data.selectLang.lang_code);
                                var app_language = {
                                ...
                                _this.lang = res.data.selectLang.lang;
                                _this.storage.set('app_language', app_language);
                                localStorage.setItem('app_language', app_language.code);
                                _this.event_provider.changeapplanguage(true);
                                document.dir = "ltr";
