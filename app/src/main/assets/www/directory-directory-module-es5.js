...
/*!***********************************************!*\
  !*** ./src/app/directory/directory.module.ts ***!
  \***********************************************/
/*! exports provided: DirectoryPageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _directory_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./directory.page */ "./src/app/directory/directory.page.ts");
...
var routes = [
    {
        path: '',
        component: _directory_page__WEBPACK_IMPORTED_MODULE_6__["DirectoryPage"]
    }
];
var DirectoryPageModule = /** @class */ (function () {
    function DirectoryPageModule() {
    }
    DirectoryPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: [_directory_page__WEBPACK_IMPORTED_MODULE_6__["DirectoryPage"]]
        })
    ], DirectoryPageModule);
...
module.exports = "table {\n  border-collapse: collapse;\n  border-spacing: 0;\n  width: 100%;\n  border: 1px solid #ddd;\n  border-bottom-color: white;\n}\n\nth, td {\n  text-align: left;\n  padding: 8px;\n  height: 50px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
/*!*********************************************!*\
  !*** ./src/app/directory/directory.page.ts ***!
  \*********************************************/
/*! exports provided: DirectoryPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _services_id_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../services/id.service */ "./src/services/id.service.ts");
...
var DirectoryPage = /** @class */ (function () {
    function DirectoryPage(platform, route, loader, storage, sermonsService, dom, router, location, common, toast, apiService, idService, translate) {
        var _this = this;
    ...
    DirectoryPage.prototype.ngOnInit = function () {
        this.link_code = this.route.snapshot.paramMap.get('code');
        this.ch_id = this.route.snapshot.paramMap.get('ch_id');
        if (!this.ch_id) {
            this.ch_id = _environments_environment_prod__WEBPACK_IMPORTED_MODULE_14__["environment"].church_id;
        }
    ...
    DirectoryPage.prototype.get_directory = function () {
        var _this = this;
        // getting directory from API through Service
        this.apiService.get_directory(this.link_code).subscribe(function (res) {
            if (res.directory) {
                var campus_id = res.directory.campus_id;
                var church_id = res.directory.church_id;
                var body = JSON.stringify({
                    church_id: church_id,
                    campus_id: +campus_id,
                });
                _this.apiService.get_directories(body).subscribe(function (dir) {
                    if (dir.status) {
                        _this.rows = dir.directory;
                        // setting data
                        _this.rows.map(function (x) { return x['name'] = x.first_last_name; });
                        _this.rows.map(function (x) { return x['zip'] = x.postal_code; });
                    }
                });
            }
        });
    };
    DirectoryPage.ctorParameters = function () { return [
        ...
        { type: _services_id_service__WEBPACK_IMPORTED_MODULE_11__["IdService"] },
        { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_13__["TranslateService"] }
    ]; };
    DirectoryPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-directory',
            template: __webpack_require__(/*! raw-loader!./directory.page.html */ "./node_modules/raw-loader/index.js!./src/app/directory/directory.page.html"),
            styles: [__webpack_require__(/*! ./directory.page.scss */ "./src/app/directory/directory.page.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_12__["Platform"],
            ...
            _services_id_service__WEBPACK_IMPORTED_MODULE_11__["IdService"],
