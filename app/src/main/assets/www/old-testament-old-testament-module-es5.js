...
var OldTestamentPageModule = /** @class */ (function () {
    function OldTestamentPageModule() {
    }
...
var OldTestamentPage = /** @class */ (function () {
    function OldTestamentPage(_bibleService, loader, toast, router, storage, event_provider, route, translate, common, audioService) {
        var _this = this;
        ...
        this.event_provider.updateOldTest.subscribe(function (value) {
            _this.bible_id = value.value.volume.dam_id;
            //  this.getBooks( this.dam_id );
            _this.getCMPBooks(_this.bible_id);
            _this.event_provider.updatenewtest(_this.bible_id); // calling event
        });
    }
    OldTestamentPage.prototype.ngOnInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var current_url, b, bible_obj;
            var _this = this;
    ...
    OldTestamentPage.prototype.selectVerse = function (item, book) {
        if (item) {
    ...
    OldTestamentPage.prototype.expandItem = function (item) {
    ...
    //         });
    // }
    OldTestamentPage.prototype.getCMPBooks = function (curr_dam_id) {
        var _this = this;
    ...
    OldTestamentPage.prototype.getCMPBooksText = function (cur_dam_id) {
        var _this = this;
    ...
    //         });
    // }
    OldTestamentPage.prototype.ionViewDidEnter = function () {
    ...
    OldTestamentPage.prototype.ionViewWillEnter = function () {
        // this.event_provider.hidefooter(false, 'old');
        // if(this.audioService.isAudioPlay == "Play"){
        //     this.audioService.togglePlayer(true)
        //     } 
    };
    OldTestamentPage.prototype.ionViewDidLeave = function () {
        // this.event_provider.hidefooter(true, 'new');
    };
    OldTestamentPage.ctorParameters = function () { return [
...
//# sourceMappingURL=old-testament-old-testament-module-es5.js.map