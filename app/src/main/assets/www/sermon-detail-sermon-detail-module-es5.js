...
var SermonDetailPageModule = /** @class */ (function () {
    function SermonDetailPageModule() {
    }
...
var SermonDetailPage = /** @class */ (function () {
    function SermonDetailPage(route, loader, storage, socialSharing, sermonsService, dom, apiService, router, location, appService, toast, modalController, translate, iab, event_provider, popoverController, platform, common, downloadService, casting, document, file, ft, fileOpener, http, _bibleService) {
        var _this = this;
        this.route = route;
        this.loader = loader;
        ...
        this.event_provider.getChurchData.subscribe(function (obj) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.storage.get('app_pages').then(function (res) {
                    ...
                    var sermon_page = res.filter(function (x) { return x.id === _this.pageid; });
                    _this.apppage_id = sermon_page[0].id;
                    _this.sermons_url = sermon_page[0].url;
                    _this.page_id = sermon_page[0].id;
                    _this.ch_id = sermon_page[0].church_id;
                    _this.title = sermon_page[0].title;
                    var notes = res.filter(function (x) { return x.page_type === 'page' && x.name === 'Show Notes'; });
                    if (notes.length > 0) {
                        _this.notes_icon = true;
                    }
                    if (obj.is_wordpress_enable == '1') {
                        _this.is_wordpress_enable = true;
                        _this.getSermonsFromCMS();
                    }
                    else {
                        // getting sermons from URL
                        // assigning data from URL Params
                        _this.sermonid = _this.route.snapshot.paramMap.get('id');
                        _this.idseries = _this.route.snapshot.paramMap.get('idseries');
                        _this.urlPubDate = _this.route.snapshot.paramMap.get('date');
                        if (_this.sermons_url.includes('.rss') || _this.sermons_url.includes('-rss')) {
                            // if url is .rss feed
    ...
    SermonDetailPage.prototype.getSermonsFromCMS = function () {
        var _this = this;
        //  console.log('inside the cmsssss');
        this.apiService.getSermon(this.ch_id, this.sermonid).subscribe(function (res) {
            _this.link_type = "sermon";
            _this.selectedSermon = res.sermons;
            _this.selectedSermon['video_link'] = _this.selectedSermon.sermon_video_url;
            _this.sermon_pubdate = _this.selectedSermon.date;
            _this.sermon_speaker = _this.selectedSermon.wpfc_preacher;
            _this.sermon_title = _this.selectedSermon.title;
            // this.selectedSermon['img_series'] = this.selectedSermon.featured_media;
            _this.selectedSermon['itunes:author'] = _this.selectedSermon.wpfc_preacher;
            _this.selectedSermon.des = _this.selectedSermon.sermon_description;
            _this.selectedSermon.sermon_note = _this.selectedSermon.sermon_note_url != null ? _this.selectedSermon.sermon_note_url : '';
            _this.selectedSermon.audio_link = _this.selectedSermon.sermon_audio != null ? _this.selectedSermon.sermon_audio : '';
            _this.selectedSermon['img_series'] = _this.selectedSermon.featured_media ? _this.selectedSermon.featured_media : '';
            _this.selected_comments = _this.selectedSermon.comments;
            _this.sermon_image = _this.selectedSermon.featured_media ? _this.selectedSermon.featured_media : '';
            if (_this.sermon_image !== "" && _this.sermon_image !== null && _this.sermon_image.includes("s3.wasabisys.com") && Object(_angular_common__WEBPACK_IMPORTED_MODULE_7__["formatDate"])(_this.selectedSermon.created_at, 'yyyy-MM-dd', 'en_US') >= '2023-05-29') {
                var abc = _this.sermon_image.split("/");
                ...
                var new_link = _this.sermon_image.replace(folder_name, _this.deviceType);
                _this.sermon_image = new_link;
                // console.log('background is: ',this.sermon_image,'new link is: ', new_link);
            }
            _this.selectedSermon['thumbnail'] = _this.selectedSermon.featured_media ? _this.selectedSermon.featured_media : '';
            if (_this.selectedSermon.wpfc_bible_book !== '' && _this.selectedSermon.wpfc_bible_book !== null) {
                _this.bible_reference_array = _this.selectedSermon.wpfc_bible_book;
            }
            if (_this.selectedSermon.audio_url) {
                _this.audio_player = true;
            }
            _this.setData();
    ...
    SermonDetailPage.prototype.ionViewDidLeave = function () {
        this.event_provider.setAudioPlayer(true);
    };
    SermonDetailPage.prototype.ngOnInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var done;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(localStorage.getItem('is_wordpress_enable') !== 'true')) return [3 /*break*/, 2];
    ...
    SermonDetailPage.prototype.getUser = function () {
        var _this = this;
        // getting user from local storage
        this.storage.get('user').then(function (res) {
            if (res != null && res != 'guest') {
                _this.isLoggedIn = true;
                _this.donor_id = res.user.id;
                _this.auth = res.auth;
            }
        });
    };
    SermonDetailPage.prototype.checkPermissions = function () {
    ...
    SermonDetailPage.prototype.openModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                if (this.selected_link) {
                    this.socialSharing.share(this.selected_link).then(function (res) {
                    }, function (err) {
                    });
                }
                return [2 /*return*/];
    ...
    SermonDetailPage.prototype.getRss = function (id, church_id) {
        var _this = this;
        ...
        this.sermonsService.get_rss(id, church_id).subscribe(function (res) {
            ...
            if (_this.sermonid === 'latest') {
                self.selectedSermon = self.allSermons;
            }
            else if (_this.urlPubDate) {
                self.selectedSermon = self.allSermons.find(function (x) { return x.pubDate === _this.urlPubDate; });
            }
            else {
                self.selectedSermon = self.allSermons.filter(function (x) { return x.guid === _this.sermonid; });
            }
            ...
            var body = JSON.stringify({
                ...
                name: _this.selectedSermon.title,
                link: _this.selectedSermon.guid
            });
            self.sermonsService.create_sermon(body).subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    return [2 /*return*/];
                });
            }); });
            // Loading all saved sermons
            self.sermonsService.get_sermons(_this.page_id).subscribe(function (res) {
                if (res && res.status) {
                    var check = res.sermons.filter(function (x) { return x.link === _this.selectedSermon.guid && x.name === _this.selectedSermon.title; });
                    if (check.length > 0) {
                        _this.selected_comments = check.comments;
                        _this.selected_comments.map(function (item) {
                            ...
                            var mytime = _this.appService.getDateTimeFormat(item.comment_time);
                            var time_diff = moment__WEBPACK_IMPORTED_MODULE_11__().utcOffset(); // in minutes
                            if (time_diff != 0) {
                        ...
                        _this.selected_id = check.id;
                        _this.selected_link = check.link;
                    }
                }
            }, function (error) {
                _this.loader.stopLoading();
    ...
    SermonDetailPage.prototype.getDate = function (date) {
        return moment__WEBPACK_IMPORTED_MODULE_11__(date).format('DD MM YYYY');
    };
    // getting sermons from URL
    SermonDetailPage.prototype.getSermonsFromWordpress = function (base_url) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var self, index;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.loader.presentLoading().then(function () {
                    _this.sermonsService.getAllSermons(base_url).subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        ...
                        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            // Loading all saved sermons
                            self.sermonsService.get_sermons(this.page_id).subscribe(function (res) {
                                if (res && res.status) {
                                    var check = res.sermons.filter(function (x) { return x.link === _this.selectedSermon.link && x.name === _this.selectedSermon.title; });
                                    if (check.length > 0) {
                                        _this.selected_comments = check.comments;
                                        if (_this.selected_comments) {
                                            _this.selected_comments.map(function (item) {
                                                try {
                                                    item.comment = JSON.parse(item.comment);
                                                    ;
    ...
    SermonDetailPage.prototype.changeTimezone = function (date, ianatz) {
    ...
    // setting data according to platform ( youtube, vimeo, wasabi)
    SermonDetailPage.prototype.setData = function () {
        var _this = this;
        var self = this;
        var youtube = 'youtube';
        ...
        if (this.link_type === "sermon") {
            ...
            this.recentSermons = this.recentSermons.filter(function (x) { return x.title != _this.sermon_title; });
            this.recentSermons.push(self.selectedSermon);
            allrecent = this.recentSermons.filter(function (x) { return x.id_series === _this.idseries; });
            ...
            if (this.sermonid === 'latest') {
                var type = self.selectedSermon.enclosure['@attributes'].type;
    ...
    SermonDetailPage.prototype.getrecentsermon = function (idseries, pubdate) {
        var _this = this;
        this.loader.presentLoading().then(function () {
            if (_this.wasabi === true) {
                _this.wasabi = false;
            }
            var self = _this;
            self.selectiveSermons = self.recentSermons.filter(function (x) { return _this.is_wordpress_enable ? x.id : x.id_series === idseries; });
            self.selectedSermon = self.selectiveSermons.find(function (x) { return x.pubDate === pubdate; });
            _this.ionContent.scrollToTop(300); //300 for animate the scroll effect.
            _this.setData();
        });
    };
    SermonDetailPage.prototype.create_comment = function () {
        var _this = this;
        if (!this.comment) {
            ...
            if (this.isLoggedIn) {
                if (this.is_wordpress_enable) {
                    ...
                    this.sermonsService.create_sermon_comment_DB(body).subscribe(function (res) {
                    ...
                    this.sermonsService.create_sermon_comment(body).subscribe(function (res) {
    ...
    SermonDetailPage.prototype.openInBrowser = function () {
        ...
        if (this.platform.is('cordova')) {
            ...
            if (this.sermon_notes.includes('.pdf')) {
                ...
                transfer.download(this.sermon_notes, path + "myfile.pdf").then(function (res) {
                    //  console.log('response from download: ', res);
                    var url2 = res.toURL();
                    // console.log('to url is: ', url2);
                    if (_this.platform.is('ios')) {
                        _this.document.viewDocument(encodeURI(url2), 'application/pdf', {});
                    }
                    else {
    ...
    //     }
    // }
    SermonDetailPage.prototype.downloadNotes = function () {
        this.downloadService.downloadNotes(this.sermon_notes);
    };
    SermonDetailPage.prototype.download = function () {
        var _this = this;
        if (this.isLoggedIn) {
            var dataBody = {
            ...
            this.downloadService.addFileToDownloads(dataBody).subscribe(function (res) {
                if (res.status) {
                    _this.alertMessage = 'File added to downloads';
                    _this.toast.presentToastWithOptions((_this.alertMessage ? _this.alertMessage.error_occured_try_again : 'Success'), (_this.alertMessage), 'Success');
                }
            });
        }
    };
    SermonDetailPage.prototype.presentPopover = function (ev) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var popover;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    ...
                    case 1:
                        ...
                        popover.onDidDismiss().then(function (res) {
                            if (res.data && res.data.event) {
                                ...
                                _this.comment += res.data.event.char;
                            }
                        });
    ...
    SermonDetailPage.prototype.startCasting = function (audio, flag, index) {
        var _this = this;
        var obj = this;
        ...
        setTimeout(function () {
            if ((_this.casting.session && _this.casting.session != '') && (_this.casting._media || _this.casting._media !== '') && (_this.casting.playURl === audio)) {
                _this.casting.requestSession(audio, 'sermon-detail', 0);
            }
            else if ((_this.casting.session && _this.casting.session != '') && (_this.casting._media || _this.casting._media !== '') && (_this.casting.playURl !== audio)) {
                _this.casting.changeAudio(audio, "audio-archieve", 0);
            }
            else {
                _this.casting.requestSession(audio, 'sermon-detail', 0);
            }
    ...
    // ZB changes
    SermonDetailPage.prototype.topicsClicked = function () {
        this.topics_clicked = true;
    };
    SermonDetailPage.prototype.bibleReferenceClicked = function () {
        this.bible_reference_clicked = true;
    };
    SermonDetailPage.prototype.bibleReferencedItemClicked = function (item) {
        var _this = this;
        if (item !== '' && item != null) {
            if (item.book_name[item.book_name.length - 1].includes(" ")) {
                var newName = item.book_name.replace(item.book_name[item.book_name.length - 1], '');
            ...
            this.storage.get('app_language').then(function (res) {
                ...
                if (res.bible_id) {
                    ...
                    _this.dam_id = res.bible_id;
                    // getting books of selected volume
                    _this.getCMPBooks(_this.dam_id);
                }
                // } 
            });
        }
    ...
    SermonDetailPage.prototype.getCMPBooks = function (curr_dam_id) {
        var _this = this;
        var self = this;
        var dam_id = curr_dam_id;
        var code = this.langCode;
        // console.log(dam_id)
        this._bibleService.getCMPbibleBooks(dam_id, this.langCode).subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var data_1, item, data_2, finalData_1;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                if (res) {
                    data_1 = [];
                    ...
                    if (this.params_book_name2 && this.params_chap_id2) {
                        item = this.books.find(function (x) {
                            return x.book_name.toLowerCase() === _this.params_book_name2.toLowerCase();
                        });
                        if (item !== null && item !== '' && item !== undefined) {
                            ...
                            this.chapters.map(function (x) {
                                var _this = this;
                                if (function (x) { return x.id !== _this.params_chap_id2.toString(); }) {
                                    x.selected = false;
                                }
                                else {
                                    x.selected = true;
    ...
    // getting text
    SermonDetailPage.prototype.getCMPBooksText = function (cur_dam_id) {
        var _this = this;
        var dam_id = cur_dam_id;
        this.loader.presentLoading().then(function () {
            _this._bibleService.getCMPbibleBooksText(dam_id).subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                var newBooksData_1, selectedBook, data;
                var _this = this;
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    if (res) {
                        newBooksData_1 = [];
                        ...
                        selectedBook = this.books.find(function (s) { return s.book_name.toLowerCase() === _this.params_book_name2.toLowerCase(); });
    ...
    SermonDetailPage.ctorParameters = function () { return [
...
//# sourceMappingURL=sermon-detail-sermon-detail-module-es5.js.map