...
var MyVolunteeringDetailPageModule = /** @class */ (function () {
    function MyVolunteeringDetailPageModule() {
    }
    ...
    return MyVolunteeringDetailPageModule;
}());
...
var MyVolunteeringDetailPage = /** @class */ (function () {
    function MyVolunteeringDetailPage(idService, route, loader, appService, storage, sermonsService, router, apiService, toast, 
    ...
    MyVolunteeringDetailPage.prototype.ngOnInit = function () {
    ...
    MyVolunteeringDetailPage.prototype.getLoginData = function () {
    ...
    // getting volunteering data
    MyVolunteeringDetailPage.prototype.getVolunteering = function () {
        var _this = this;
        this.loader.presentLoading().then(function () {
            ...
            _this.apiService.getVolunteering(JSON.stringify(body)).subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                var data, record_id_data, id_data, filtered;
                var _this = this;
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    data = res.volunteering[0];
                    record_id_data = data.filter(function (x) { return x.record_id; });
                    id_data = data.filter(function (x) { return x.id; });
                    if (this.record_id != "null") {
                        filtered = record_id_data.filter(function (x) { return x.record_id === _this.record_id; });
                    }
                    else if (this.id != "null") {
                        filtered = id_data.filter(function (x) { return x.id === _this.id; });
                    }
    ...
    MyVolunteeringDetailPage.prototype.gotobackPage = function () {
        this.location.back();
    };
    MyVolunteeringDetailPage.ctorParameters = function () { return [
    ...
    return MyVolunteeringDetailPage;
}());
...
//# sourceMappingURL=my-volunteering-detail-my-volunteering-detail-module-es5.js.map