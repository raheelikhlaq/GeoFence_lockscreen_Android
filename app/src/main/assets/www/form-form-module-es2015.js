...
let FormPage = class FormPage {
    constructor(route, loader, storage, sermonsService, dom, router, location, common, toast, analytics, event_provider, platform, device, translate) {
        this.route = route;
        this.loader = loader;
            ...
            if (theme) {
                ...
                this.event_provider.getChurchData.subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                    if (!(Object.keys(res).length === 0)) {
                        ...
                        let app_pages = res.apppages.filter(x => x.id === this.form_id.toString());
                        if (app_pages[0]) {
