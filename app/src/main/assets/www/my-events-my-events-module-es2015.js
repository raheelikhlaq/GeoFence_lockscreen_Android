...
let MyEventsPageModule = class MyEventsPageModule {
};
...
let MyEventsPage = class MyEventsPage {
    constructor(apiService, storage, loader, appService, Auth, router, location, toast, analytics, platform, device, translate, event_provider) {
...
//# sourceMappingURL=my-events-my-events-module-es2015.js.map