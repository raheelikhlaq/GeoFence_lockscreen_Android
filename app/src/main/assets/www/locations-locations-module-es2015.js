...
let LocationsPage = class LocationsPage {
    constructor(storage, loader, apiService, router, location, toast, analytics, common, event_provider, platform, device, translate) {
    ...
    getAppPages() {
        this.storage.get('app_pages').then(res => {
            if (res) {
                ...
                let page = res.find(x => x.name === 'Locations');
                if (page) {
    ...
    ionViewWillEnter() {
        ...
        this.event_provider.getChurchData.subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (!(Object.keys(res).length === 0)) {
                // asking for password
                let app_pages = res.apppages.find(x => x.name === 'Locations');
    ...
    getChurchLocations() {
        ...
        this.apiService.get_church_locations(this.church_id).subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (res.status) {
    ...
    setAnalytics() {
        ...
        let end_time_analytics = moment__WEBPACK_IMPORTED_MODULE_6__();
