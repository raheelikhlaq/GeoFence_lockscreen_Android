...
var CallStudioPageModule = /** @class */ (function () {
    function CallStudioPageModule() {
    }
...
var CallStudioPage = /** @class */ (function () {
    function CallStudioPage(location, storage, common, eventProvider, analytics, platform, device, translate, api) {
    ...
    CallStudioPage.prototype.ngOnInit = function () {
    };
    CallStudioPage.prototype.ionViewWillEnter = function () {
        this.getTheme();
    };
    CallStudioPage.prototype.getTheme = function () {
        var _this = this;
                ...
                _this.common.getTheme(body).subscribe(function (theme) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                    ...
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                        ...
                        if (theme && theme.status) {
                            page = theme.apppages.find(function (x) { return x.activated === 'true' && x.name === "Call Studio"; });
                            myPage = page;
                            this.page = myPage;
    ...
    CallStudioPage.prototype.getCalls = function () {
        var _this = this;
        this.api.getCallStudio(this.ch_id).subscribe(function (res) {
            if (res && res.status === true) {
                _this.calls = res.groups;
            }
        });
    };
    CallStudioPage.prototype.gotobackPage = function () {
        this.location.back();
    };
    CallStudioPage.ctorParameters = function () { return [
...
//# sourceMappingURL=call-studio-call-studio-module-es5.js.map