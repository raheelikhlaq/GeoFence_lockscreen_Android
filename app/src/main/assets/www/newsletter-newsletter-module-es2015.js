...
let NewsletterPage = class NewsletterPage {
    constructor(sermonsService, storage, route, loader, api, router, event_provider, dom, location, common, platform, appService) {
    ...
    ngOnInit() {
        ...
        this.event_provider.getChurchData.subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (res && !(Object.keys(res).length === 0)) {
                ...
                let app_pages = res.apppages.find(x => x.name === 'Newsletter');
                if (app_pages) {
    ...
    getNewsLetters() {
        this.api.getnewsletter(this.ch_id).subscribe((res) => {
            if (res.message === 'Successfully fetched') {
                this.news = res.posts;
                this.news.forEach(eachNews => {
                    if (eachNews.attachment !== "" && eachNews.attachment !== null && eachNews.attachment.includes("s3.wasabisys.com") && Object(_angular_common__WEBPACK_IMPORTED_MODULE_9__["formatDate"])(eachNews.created_at, 'yyyy-MM-dd', 'en_US') >= '2023-05-29') {
                        let abc = eachNews.attachment.split("/");
                        ...
                        let new_link = eachNews.attachment.replace(folder_name, this.deviceType);
...
//# sourceMappingURL=newsletter-newsletter-module-es2015.js.map