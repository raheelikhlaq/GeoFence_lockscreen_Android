...
/* harmony import */ var angular2_qrscanner__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! angular2-qrscanner */ "./node_modules/angular2-qrscanner/esm2015/angular2-qrscanner.js");
...
/* harmony import */ var angular2_qrscanner__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! angular2-qrscanner */ "./node_modules/angular2-qrscanner/esm2015/angular2-qrscanner.js");
...
let CheckInPage = class CheckInPage {
    constructor(platform, route, loader, storage, sermonsService, dom, router, location, common, toast, api, scannerModal, modalController, idService, translate) {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            let link_code = this.route.snapshot.paramMap.get('link_code');
    ...
    launcgQrScanner() {
        ...
        this.qrScannerComponent.capturedQr.subscribe(result => {
            if (result) {
                this.loadProfileQR(result);
            }
            this.camera = !this.camera;
        });
    }
    getCheckInData(id, link_code) {
        this.api.get_checkin(id, link_code).subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (res.status) {
    ...
    getPeople(church_id) {
        this.api.get_people(church_id).subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
    ...
    set_confirmation(obj) {
        if (this.confirmation && obj.first_last_name === this.confirmation.first_last_name) {
            ...
            this.api.get_household(body).subscribe((res) => {
                if (res.status) {
                    this.household = res.family;
                    for (let i = 0; i < this.household.length; i++) {
                        this.household[i]['checkin_toggle'] = 0;
                        this.household[i]['type'] = '';
                        this.household[i]['relation_name'] = this.household[i].relation.name;
                    }
                }
            });
            this.confirmation_user_type = this.audience_options[0].name;
    ...
    createPerson() {
        ...
        this.api.create_person(body).subscribe((res) => {
            if (res.status) {
                this.ngOnInit();
                // clearing input data
                this.name = '';
                ...
                this.membership = '';
                this.is_volunteer = '';
                this.toast.presentToastWithOptions((this.alertMessage ? this.alertMessage.PersonSuccessfully : 'Person Created Successfully'), (this.alertMessage ? this.alertMessage.Success : 'Success'), 'success');
            }
        });
    }
    checkin() {
    ...
    loadProfileQR(qr_id) {
        ...
        this.api.load_profileQR(body).subscribe((res) => {
            if (res.status) {
                this.confirmation = res.data;
                this.scan_done = false;
            }
        });
    }
    gotobackPage() {
...
//# sourceMappingURL=check-in-check-in-module-es2015.js.map