        ...
        children: [
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: function () { return __webpack_require__.e(/*! import() | ism-bible-ism-bible-module */ "ism-bible-ism-bible-module").then(__webpack_require__.bind(null, /*! ../ism-bible/ism-bible.module */ "./src/app/ism-bible/ism-bible.module.ts")).then(function (m) { return m.IsmBiblePageModule; }); }
                    }
                ]
            },
            {
...
var IsmTeachingsPageRoutingModule = /** @class */ (function () {
    function IsmTeachingsPageRoutingModule() {
    }
    ...
    return IsmTeachingsPageRoutingModule;
}());
...
var IsmTeachingsPageModule = /** @class */ (function () {
    function IsmTeachingsPageModule() {
    }
...
var IsmTeachingsPage = /** @class */ (function () {
    function IsmTeachingsPage(location, router, menu, translate, audioService, event_provider) {
    ...
    IsmTeachingsPage.prototype.ngOnInit = function () {
        // this.event_provider.hidefooter(false, 'other');
    };
    IsmTeachingsPage.prototype.ionViewDidEnter = function () {
        // this.event_provider.hidefooter(false, 'other');
    };
    // navigating to back page
    IsmTeachingsPage.prototype.gotobackPage = function () {
        //  this.menu.toggle();
        // this.audioService.setLiveSteam();
        // this.event_provider.hidefooter(true, 'other');
        this.location.back();
    };
    IsmTeachingsPage.prototype.ionViewDidLeave = function () {
        // this.audioService.setLiveSteam();
        // this.event_provider.hidefooter(true, 'other');
    };
    IsmTeachingsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=ism-teachings-ism-teachings-module-es5.js.map