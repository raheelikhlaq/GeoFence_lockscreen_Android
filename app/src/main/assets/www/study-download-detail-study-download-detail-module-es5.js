...
var StudyDownloadDetailPageModule = /** @class */ (function () {
    function StudyDownloadDetailPageModule() {
    }
    ...
    return StudyDownloadDetailPageModule;
}());
...
var StudyDownloadDetailPage = /** @class */ (function () {
    function StudyDownloadDetailPage(location, route, audioService, service, actionSheetController, toast, downloadService, platform, modalController, storage, socialSharing, _bibleService, router) {
    ...
    StudyDownloadDetailPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    StudyDownloadDetailPage.prototype.gotobackPage = function () {
        this.location.back();
    };
    StudyDownloadDetailPage.prototype.playTodayStudy = function (isplay) {
        var _this = this;
        ...
        if (this.audioService.audioUrl == audiourl) {
            ...
            setTimeout(function () {
                ...
                _this.audioData['image'] = _this.audioData.art_url;
                ...
                _this.audioService.title = _this.audioData.name;
                _this.audioService.isAudioPlayShows = !isplay;
                _this.audioService.image = _this.audioData.art_url;
                _this.service.audioData = _this.audioData;
                _this.audioService.organization = _this.audioData.organization;
                _this.audioService.is_today_study = true;
                _this.audioService.study_image = _this.audioData.art_url;
                _this.audioService.startAudio(audiourl);
            }, 500);
        }
    };
    StudyDownloadDetailPage.prototype.seek = function () {
        var _this = this;
    ...
    StudyDownloadDetailPage.prototype.downloadCompoent = function (today) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        flag = (today.book_id ? today.book_id : today.cmp_book_id) ? false : true;
    ...
    StudyDownloadDetailPage.prototype.shareURL = function (audio) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var actionSheet;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.socialSharing.share("Study Thru The Bible - " + audio.name + " \n" + src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].cmp_audioLink + audio.uuid).then(function (data) {
                        }, function (error) {
                        });
                        return [3 /*break*/, 4];
    ...
    StudyDownloadDetailPage.prototype.ReadTheBiblePassage = function (item) {
        console.log(item);
        var item2 = this.books.find(function (x) { return x.id === (item.book_id ? item.book_id : item.cmp_book_id); });
        console.log(item2);
        if (item2) {
            var data = {
                queryParams: {
    ...
    StudyDownloadDetailPage.prototype.getCMPBooks = function (bible_id) {
        var _this = this;
        var self = this;
    ...
    StudyDownloadDetailPage.ctorParameters = function () { return [
    ...
    return StudyDownloadDetailPage;
}());
...
//# sourceMappingURL=study-download-detail-study-download-detail-module-es5.js.map