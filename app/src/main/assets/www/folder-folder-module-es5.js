...
var FolderPage = /** @class */ (function () {
    function FolderPage(route, loader, storage, sermonsService, dom, router, location, common, toast, analytics, event_provider, platform, device, iab, translate) {
        var _this = this;
        this.route = route;
        this.loader = loader;
    ...
    FolderPage.prototype.getGradient = function (color_one, bg_color) {
        if (bg_color === '') {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.event_provider.getChurchData.subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                    var app_pages, data, countdown_card;
                    var _this = this;
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                        if (!(Object.keys(res).length === 0)) {
                            ...
                            app_pages = res.apppages.find(function (x) { return x.id === _this.folder_id; });
                            if (app_pages) {
                                // layout for ISM =========================================
                                if (this.ch_id === '994' && app_pages.id === '3459') {
                                    this.ism_layout_enable = true;
                                    if (app_pages.side_menu_data) {
                                        data = JSON.parse(app_pages.side_menu_data);
                                ...
                                this.cards.forEach(function (card) {
                                    if (card.background !== "" && card.background !== null && card.background.includes("s3.wasabisys.com") && Object(_angular_common__WEBPACK_IMPORTED_MODULE_7__["formatDate"])(card.created_at, 'yyyy-MM-dd', 'en_US') >= '2023-05-29') {
                                        ...
                                        var new_link = card.background.replace(folder_name, _this.deviceType);
                            ...
                            countdown_card = this.cards.filter(function (x) { return x.card_type === 'countdown'; });
                            ...
                            if (app_pages) {
                                ...
                                setInterval(function () {
                                    var countdown_card = _this.cards.filter(function (x) { return x.card_type === 'countdown'; });
                                    countdown_card.map(function (x) {
                                        var temp = [];
                                        if (x.time) {
                                            for (var i = 0; i < JSON.parse(x.time).length; i++) {
                                                temp.push(_this.diff_minutes(JSON.parse(x.time)[i].time));
                                            }
                                            x.timeleft = temp;
                                            x.current_timeline = temp[x.count];
                                            if (x.current_timeline) {
    ...
    FolderPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.ngOnInit();
        this.event_provider.getChurchData.subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var id, app_pages;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                if (!(Object.keys(res).length === 0)) {
                    id = this.route.snapshot.paramMap.get('folder_id');
    ...
    FolderPage.prototype.getHomeTopPosts = function (url) {
        var self = this;
                ...
                if (self.hometop_posts.length > 0) {
                    self.hometop_posts.map(function (x) {
                        ...
                        if (self.ism_top_card_links.length) {
                            self.ism_top_card_links.map(function (y) {
    ...
    FolderPage.prototype.getHomeBottomPosts = function (url) {
        var self = this;
        // fetch notes by category
                ...
                if (self.homebottom_posts.length > 0) {
                    self.homebottom_posts.map(function (x) {
                        ...
                        if (self.ism_bottom_card_links.length) {
                            self.ism_bottom_card_links.map(function (y) {
                                if (y.title == x.title[0] && y.link_match == x.link[0]) {
                                    x['page_link'] = y.link;
                                }
                            });
    ...
    FolderPage.prototype.getUser = function () {
        var _this = this;
    ...
    FolderPage.prototype.diff_minutes = function (date) {
        var myMoment = moment__WEBPACK_IMPORTED_MODULE_10__(date, "YYYY-MM-DD HH:mm:ss");
        var ok = moment__WEBPACK_IMPORTED_MODULE_10__();
    ...
    FolderPage.prototype.gotobackPage = function () {
        this.location.back();
    };
    FolderPage.prototype.goToIframe = function (url) {
        if (url) {
    ...
    FolderPage.prototype.goToPage = function (pageName, pageId, event) {
        if (event !== '') {
        ...
        if (pageName && pageId) {
            if (pageName === 'Audio') {
                ...
                var link_page = this.app_pages.find(function (x) { return x.id === pageId; });
                if (link_page) {
                    var open_external = link_page.open_external;
                    if (open_external === 'true') {
                        var donations_url = _environments_environment__WEBPACK_IMPORTED_MODULE_17__["environment"].domain_name + "/give-new/" + link_page.html;
            ...
            if (pageName === 'Today Study') {
                ...
                if (localStorage.getItem('is_wordpress_enable') === 'true') {
                    var form_page = this.app_pages.filter(function (x) { return x.id === pageId; });
    ...
    FolderPage.prototype.openurlinapp = function (url) {
    ...
    FolderPage.prototype.openurlinbrowser = function (url) {
        this.iab.create(url, '_system');
    };
    FolderPage.prototype.setAnalytics = function () {
        var dev_id = '';
        var device = 'web';
    ...
    FolderPage.prototype.ionViewDidLeave = function () {
        this.setAnalytics();
    };
    FolderPage.prototype.ionViewDidEnter = function () {
    ...
    FolderPage.ctorParameters = function () { return [
