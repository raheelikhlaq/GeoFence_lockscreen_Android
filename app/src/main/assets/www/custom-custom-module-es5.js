...
var CustomPage = /** @class */ (function () {
    function CustomPage(location, apiService, storage, dom, common, 
            ...
            _this.common.getTheme(body).subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                ...
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    if (res) {
                        ...
                        app_pages = res.apppages.filter(function (x) { return x.name === 'Custom Page'; });
                        if (app_pages[0]) {
        ...
        this.event_provider.getChurchData.subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                if (!(Object.keys(res).length === 0)) {
                    app_pages = res.apppages.find(function (x) { return x.name === 'Custom Page'; });
    ...
    CustomPage.prototype.ionViewDidEnter = function () {
        this.event_provider.hidefooter(true, 'other');
    };
    CustomPage.prototype.loadUrl = function (ch_id) {
        var body = ch_id;
        this.apiService.get_custom_url(body).subscribe(function (res) {
            // ------------------TESTING PURPOSE-------------
    ...
    CustomPage.prototype.getTheme = function () {
        var _this = this;
        this.storage.get('theme').then(function (res) {
            if (res) {
                _this.ch_id = res.ch_id;
                _this.loadUrl(_this.ch_id);
            }
        });
    };
    CustomPage.prototype.gotobackPage = function () {
        this.location.back();
    };
    CustomPage.ctorParameters = function () { return [
