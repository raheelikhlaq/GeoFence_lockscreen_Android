...
let MyContributionsPageModule = class MyContributionsPageModule {
};
...
let MyContributionsPage = class MyContributionsPage {
    constructor(apiService, storage, loader, Auth, location, toast, analytics, platform, device, alertController, translate, menu, event_provider, logoService, router) {
    ...
    presentAlertConfirm(subscription_id) {
                ...
                buttons: [
                    {
                        ...
                        text: 'Yes',
                        handler: () => {
                            this.stopSubscription(subscription_id);
                        }
                    }
                ]
            });
    ...
    getContributionData() {
        ...
        this.loader.presentLoading().then(() => {
            ...
            this.apiService.getContributions(JSON.stringify(body)).subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                if (res.status) {
                    // =================== Assigning Data ================================================================= //
    ...
    stopSubscription(id) {
        ...
        this.apiService.stopSubscription(JSON.stringify(body)).subscribe((res) => {
            if (res.status) {
                this.ngOnInit();
                this.toast.presentToastWithOptions(res.message, "Success", "success");
            }
            else {
                this.toast.presentToastWithOptions(res.message, "Warning", "warning");
            }
        });
    }
    // Hides and Shows donations data
    see_more_or_less_donations() {
...
MyContributionsPage.ctorParameters = () => [
...
//# sourceMappingURL=my-contributions-my-contributions-module-es2015.js.map