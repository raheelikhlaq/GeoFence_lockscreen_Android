...
var SermonNotesPageModule = /** @class */ (function () {
    function SermonNotesPageModule() {
    }
...
var SermonNotesPage = /** @class */ (function () {
    function SermonNotesPage(idService, route, loader, storage, sermonsService, router, eventsService, apiService, appService, toast, location, common, event_provider, analytics, platform, device, translate) {
        var _this = this;
    ...
    SermonNotesPage.prototype.ngOnInit = function () {
        var _this = this;
        // getting theme
        this.getTheme();
    ...
    SermonNotesPage.prototype.getTheme = function () {
        var _this = this;
        ...
        this.event_provider.getChurchData.subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                if (res.apppages.length > 0) {
                    sermon_page = res.apppages.filter(function (x) { return x.page_type === 'page' && x.name === 'Show Notes'; });
    ...
    SermonNotesPage.prototype.getDBNotes = function () {
        var _this = this;
        this.loading_data = false;
        ...
        this.sermonsService.getCMSSermonNotes(body).subscribe(function (res) {
            ...
            self.allNotes.forEach(function (element) {
                element['description'] = [];
    ...
    SermonNotesPage.prototype.getNotes = function (url) {
        var _this = this;
        this.loading_data = false;
        this.loader.presentLoading().then(function () {
            var self = _this;
    ...
    SermonNotesPage.prototype.openDetail = function (i) {
        var md5 = __webpack_require__(/*! md5 */ "./node_modules/md5/md5.js");
        // hashing data before sending
        var hashed_date = md5(this.allNotes[i].pubDate);
        var hashed_title = md5(this.allNotes[i].title);
    ...
    SermonNotesPage.prototype.gotobackPage = function () {
        this.location.back();
    };
    SermonNotesPage.prototype.getUser = function () {
        var _this = this;
    ...
    SermonNotesPage.prototype.setAnalytics = function () {
        var dev_id = '';
        var device = 'web';
    ...
    SermonNotesPage.prototype.ionViewDidLeave = function () {
        this.setAnalytics();
    };
    SermonNotesPage.prototype.ionViewDidEnter = function () {
    ...
    SermonNotesPage.ctorParameters = function () { return [
...
//# sourceMappingURL=sermon-notes-sermon-notes-module-es5.js.map