...
object Keys {
    ...
    // application name
    const val APPLICATION_NAME: String = "MediaPlayer"
    ...
    const val SKIP_BACK_TIME_SPAN: Long = 15000L            // 15 seconds in milliseconds
    const val SKIP_FORWARD_TIME_SPAN: Long = 15000L         // 15 seconds in milliseconds
    ...
    // intent actions
    const val ACTION_SHOW_PLAYER: String = "com.tmt.mediaplayer.action.SHOW_PLAYER"
    const val ACTION_COLLECTION_CHANGED: String = "com.tmt.mediaplayer.action.COLLECTION_CHANGED"
    const val ACTION_PROGRESS_UPDATE: String = "com.tmt.mediaplayer.action.PROGRESS_UPDATE"
    const val ACTION_STOP: String = "com.tmt.mediaplayer.action.STOP"
    const val ACTION_DISMISS: String = "com.tmt.mediaplayer.action.DISMISS"
    ...
    // locations
    const val LOCATION_DEFAULT_COVER: String = "android.resource://com.tmt.mediaplayer/drawable/ic_default_cover_rss_icon_192dp"
